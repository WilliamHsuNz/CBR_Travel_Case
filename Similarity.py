...
def holiday_type(query_case, source_case):
	...
	similarity = holiday_type_matrix[holiday_type_dict[query_case]][holidaty_type_dict[source_case]]
	return similarity
...
def season(query_case, source_case):
	...
	query_seaon = season_dict[query_case]
	source_season = season_dict[source_case]
